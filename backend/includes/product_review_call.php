<form action="/student024/shop/backend/views/product_review.php" method="GET">
    <input type="hidden" name="product_id" id="product_id" value="<?php echo $product_id; ?>" required readonly>
