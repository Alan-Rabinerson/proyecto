...
<?php include $_SERVER['DOCUMENT_ROOT'].'/student024/shop/backend/config/db_connect.php';
    ...
    $sql = "UPDATE 024_orders_table SET customer_id = $customer_id, order_date = '$order_date', product_id = $product_id, quantity = $quantity, address_id = $address_id, method_id = $method_id WHERE order_number = $order_number";
